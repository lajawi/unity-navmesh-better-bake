...
namespace Lajawi
{
    ...
    class BetterNavMeshSurfaceEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(Application.isPlaying || m_AgentTypeID.intValue == -1))
            {
                ...
                using (new EditorGUI.DisabledScope(targets.All(s => (s as NavMeshSurface)?.navMeshData == null)))
                {
                    ...
                    {
                        BetterNavMeshSurfaceHook.DestroyTrees();
                ...
                {
                    BetterNavMeshSurfaceHook.OnPreBake();
            ...
            EditorGUILayout.HelpBox("Better NavMesh Surface package active.", MessageType.Info);
        }
